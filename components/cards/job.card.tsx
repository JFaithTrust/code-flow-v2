...
const JobLocation = ({ job_country, job_city, job_state }: JobLocationProps) => {
  return (
    <div className="flex items-center justify-end gap-2 rounded-2xl background-light800_dark400 px-3 py-1.5">
      <Image
...
const JobCard = ({ job }: { job: Job }) => {
  ...
  return (
    <section className="flex flex-col items-start gap-6 rounded-lg border light-border background-light900_dark200 p-6 shadow-light100_darknone sm:flex-row sm:p-8">
      ...
      <div className="flex items-center gap-6">
        {employer_logo ? (
          <Link
            ...
            className="relative size-16 rounded-xl background-light800_dark400"
          >
            <Image
              src={employer_logo}
              alt="company logo"
      ...
      <div className="w-full">
        ...
        <div className="mt-8 flex-between flex-wrap gap-6">
